...
// Font Awesome 7 Free Solid icon codepoints (UTF-8 encoded).
// Glyph range: 0xf000 .. 0xf8ff (merged into main font via MergeMode).
...
// File operations
#define ICON_FA_FILE          "\xef\x85\x9c"  // U+F15C
...
// Undo / redo
#define ICON_FA_UNDO          "\xef\x83\xa2"  // U+F0E2  rotate-left
#define ICON_FA_REDO          "\xef\x80\x9e"  // U+F01E  rotate-right

// Playback
#define ICON_FA_PLAY          "\xef\x81\x8b"  // U+F04B
#define ICON_FA_PAUSE         "\xef\x81\x8c"  // U+F04C
#define ICON_FA_STOP          "\xef\x81\x8d"  // U+F04D
#define ICON_FA_STEP_FORWARD  "\xef\x81\x91"  // U+F051  forward-step

// History / tags
#define ICON_FA_CLOCK         "\xef\x87\x9a"  // U+F1DA  clock-rotate-left
#define ICON_FA_TAG           "\xef\x80\xab"  // U+F02B

// Debug / fuzz
#define ICON_FA_BUG           "\xef\x86\x88"  // U+F188
#define ICON_FA_DICE          "\xef\x94\xa2"  // U+F522
#define ICON_FA_ROUTE         "\xef\x93\x97"  // U+F4D7  (diamond-turn-right)
