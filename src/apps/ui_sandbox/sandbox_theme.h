...
inline void SetThemeColors(ThemeId id) {
    ...
    case ThemeId::Olive:
        BackgroundPrimary   = ImVec4(0.09f, 0.10f, 0.07f, 1.0f);
        BackgroundSecondary = ImVec4(0.13f, 0.15f, 0.10f, 1.0f);
        BackgroundTertiary  = ImVec4(0.17f, 0.19f, 0.14f, 1.0f);
        AccentPrimary       = ImVec4(0.55f, 0.70f, 0.25f, 1.0f);
        AccentSecondary     = ImVec4(0.38f, 0.48f, 0.18f, 1.0f);
        AccentHover         = ImVec4(0.62f, 0.78f, 0.32f, 1.0f);
        Success             = ImVec4(0.30f, 0.62f, 0.35f, 1.0f);
        Warning             = ImVec4(0.80f, 0.62f, 0.20f, 1.0f);
        Error               = ImVec4(0.75f, 0.30f, 0.25f, 1.0f);
        Info                = ImVec4(0.45f, 0.65f, 0.40f, 1.0f);
        TextPrimary         = ImVec4(0.90f, 0.92f, 0.85f, 1.0f);
        TextSecondary       = ImVec4(0.65f, 0.68f, 0.58f, 1.0f);
        TextDisabled        = ImVec4(0.42f, 0.44f, 0.38f, 1.0f);
        FrameBackground     = ImVec4(0.15f, 0.17f, 0.12f, 1.0f);
        Border              = ImVec4(0.28f, 0.30f, 0.22f, 1.0f);
        FrameBorder         = ImVec4(0.24f, 0.26f, 0.20f, 1.0f);
        Selection           = ImVec4(0.55f, 0.70f, 0.25f, 0.25f);
        CardBg              = ImVec4(0.12f, 0.13f, 0.09f, 1.0f);
        CardBorder          = ImVec4(0.25f, 0.28f, 0.18f, 0.7f);
        CanvasBg            = ImVec4(0.08f, 0.09f, 0.06f, 1.0f);
        CanvasDot           = IM_COL32(200, 210, 160, 16);
        CanvasDotMajor      = IM_COL32(200, 210, 160, 38);
        CanvasLabel         = IM_COL32(200, 210, 160, 30);
        break;
